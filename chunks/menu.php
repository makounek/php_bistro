...
<section class="fcategories">
    ...
    <div class="container">
        ...
        <div class="section white center">
            <h3 class="header">Denní nabídka <?php $timestamp = time();  echo date('d.m.Y', $timestamp);?>:</h3>
        </div>
                        ...
                        <div class="col s12 m4">
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="card-content">
                                        <p>Počet zbývajících porcí: <?php echo $arr_all[$i+$j-2]['pocet_porci'];?></p>
                                    </div>
                                    <div class="card-content center">
                                        <a href="./backends/order-food.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>" style="background: #ee6e73;" class="btn waves-effect waves-block waves-light" href="">Objednat</a>
                                    </div>
                                </div>
                                <div class="card-reveal">
                                    <span class="card-title grey-text text-darken-4"><?php echo $arr_all[$i+$j-2]['fname']; ?><i class="material-icons right">X</i></span>
