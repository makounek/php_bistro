	...
	<div id="modal2" class="modal">
	    <div class="modal-content center">
	      ...
	      <form>
	          ...
	          <label for="name_reg">Jméno</label>
	    ...
	    <div class="row">
	        ...
	        <div class="input-field col s6">
	          ...
	          <label for="con_password_reg">Potvrď heslo</label>
	        </div>
	        
		  </div>

		  <a href="javascript:void(0)" id="submit_reg" class="waves-effect waves-light btn" style="background: #ee6e73 !important;">Registrovat</a>
