<section class="fdes">
		<div class="section white center">
			<h2 class="header" style="padding:20px; padding-bottom: 30px;">Bistro U Dvou přátel</h2>
		      <div class="row container center">
		        ...
		        <div class="col center l4 s12">
		        	<img height="300" width="auto" style="object-fit: contain;" src="images/dva_pratele.jpg" alt="">
		        </div>
